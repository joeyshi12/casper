...
/** Chevron pointing down - used on dropdown triggers. */
...
/** Checkmark - marks the selected option in a dropdown. */
...
/** Spinning loader ring. Animated via the `.spinner` CSS class. */
export function Spinner({ size = 28, className }: IconProps) {
  return (
    <svg
...
export function FolderOpenIcon({ size = 16, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2 10l2.5 9h15l2.5-9H7.5" />
    </svg>
  );
}
...
/** `</>` - the source view, paired with EyeIcon in the preview toggle. */
...
/** Diagonal arrows pointing out - enter fullscreen. */
...
/** Diagonal arrows pointing in - leave fullscreen. */
export function ShrinkIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
